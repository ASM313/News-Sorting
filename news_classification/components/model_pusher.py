...
from news_classification.entity.artifact_entity import ModelPusherArtifact,ModelTrainerArtifact,ModelEvaluationArtifact
from news_classification.entity.config_entity import ModelEvaluationConfig,ModelPusherConfig
import os,sys
